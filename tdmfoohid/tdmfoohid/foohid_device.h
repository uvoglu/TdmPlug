...
class com_uvoglu_tdmfoohid_device : public IOHIDDevice {
    OSDeclareDefaultStructors(com_uvoglu_tdmfoohid_device)
...
private:
    ...
    com_uvoglu_tdmfoohid_userclient *m_user_client = nullptr;
};
