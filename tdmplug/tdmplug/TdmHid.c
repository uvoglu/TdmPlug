...
#define SERVICE_NAME "com_uvoglu_tdmfoohid"

#define FOOHID_CREATE 0  // create selector
#define FOOHID_SEND 2  // send selector

#define DEVICE_NAME "TDM Virtual Keyboard (foohid)"
#define DEVICE_SN "UVOGLU.COM"
...
void toggleTdmHid() {
    ...
    // -- START TARGET DISPLAY MODE
        
    // PRESS CMD
    memset(&report, 0, sizeof(report));
    // report.keyboard.report_id = 0x01; is set to this to make clear that
    // it's about keyboard usage
    ...
    report.keyboard.modifiers = 0x80;
    ...
    // PRESS BRIGHTNESS UP
    memset(&report, 0, sizeof(report));
    // report.consumer.report_id = 0x02; is set to this to make clear that
    // it's about consumer usage
    report.consumer.report_id = 0x02;
    report.consumer.key_codes[0] = kHIDUsage_Csmr_DisplayBrightnessIncrement;
    ...
    // https://developer.apple.com/library/archive/technotes/tn2450/_index.html
    report.keyboard.key_codes[0] = 0x00;
    report.keyboard.modifiers = 0x00;
